...
const SurveyLayout = ({ children }: { children: React.ReactNode }) => (
  <div className="mx-auto max-w-5xl px-4 py-8 min-h-screen flex flex-col">
    ...
    <footer className="text-center py-6 text-xs font-mono text-white/20 mt-auto">
...
export default function SurveyPage() {
  ...
  if (step === 1) {
    return (
      <SurveyLayout>
        <div className="max-w-md mx-auto card rounded-2xl p-8 shadow-2xl transform transition-all hover:shadow-blue-900/20">
  ...
  if (step === 2) {
    return (
      <SurveyLayout>
        <div className="max-w-md mx-auto card rounded-2xl p-8 shadow-2xl">
